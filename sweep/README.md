...
- 平均待ち時間と95%待ち時間: 利用者が実感しやすい改善です。
- 平均総所要時間: 待ち時間だけでなく、乗車後の遅れや保持も含めた総合指標です。
- 車間RMSEと最大車間: 運行が等間隔に近づいたかを見る主指標です。団子度は補助診断として確認します。
- スキップ人数と保持累計分: 改善の副作用です。大きい場合は採用候補から外すか、条件を弱めます。

基本的には、平均待ち時間・総所要時間・車間RMSEが同時に下がり、スキップ人数や保持累計分が過大でない候補を優先します。
...
| 指標 | 良い方向 | 使いどころ |
| --- | --- | --- |
| 平均総所要時間 | 小さいほど良い | 待ち始めから降車までの利用者目線の総合指標です。最優先候補にできます。 |
| 平均待ち時間 | 小さいほど良い | 利用者が最も実感しやすい改善です。 |
| 95%待ち時間 | 小さいほど良い | 悪い側の待ち時間です。平均だけ改善して一部利用者が悪化していないか見ます。 |
