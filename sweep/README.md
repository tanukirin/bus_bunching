...
| 3 | スキップ人数 | `skippedPassengers` | 小さいほど良い | 期間中に一度以上スキップで乗車を見送られた人数です。利用者負担の代表指標です。 |
| 3 | スキップ平均追加待ち | `skipAvgExtraMin` | 小さいほど良い | スキップされた人の、初回スキップから実乗車までの平均時間です。 |
| 3 | スキップ最大追加待ち | `skipMaxExtraMin` | 小さいほど良い | スキップされた人の追加待ち最大値です。苦情リスクを見ます。 |
...
| 2 | 複数回スキップ人数 | `multiSkippedPassengers` | 小さいほど良い | 2回以上スキップされた人数です。公平性上の副作用を見ます。 |
| 2 | スキップ後満員影響人数 | `deniedAfterSkip` | 小さいほど良い | スキップ後に満員などでさらに乗れなかった人数です。悪い連鎖を見ます。 |
...
| 2 | 総スキップ数 | `totalSkips` | 小さいほど良い | バス側から見たスキップ実行回数の合計です。 |
